...
// //Сперва идет вызов первой функции а=1, потом вызов функции b=2
// f(1)(2);
...
//props которые приходят в наш HOC мы передаем в наш внутренний компонент BaseComponent с помощью spread оператора {...props}
